			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					<div class="features_items"><!--Product List-->
						<h2 class="title text-center"><?php echo $_POST['heading']; ?></h2>

				<?php
					$products = CreateProduct::getProductsByCategory($_POST['category']);
					$count = 0;
					if($products == 0 or $products == 1){
					    echo "<div class='alert alert-info'>No product for sale in this category</div>";
					}else{
							...
							<div class="product-image-wrapper">
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="#"><i class="fa fa-plus-square"></i>Reviews: <small>323</small></a></li>
										<li><a href="#"><i class="fa fa-plus-square"></i>Purchases: <small>83</small></a></li>
									</ul>
								</div>
							</div>
						</div>
