...
<?php require_once("../gen/gen/product.php"); ?>
	...
	<?php $products = CreateProduct::getProductDetails($id); ?> 
			
	<?php var_dump($products); foreach($products['result'] as $product){ ?>				
					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							...
							<div class="product-information"><!--/product-information-->
								...
								<p><?php if(!empty($product['Additional'])){ ?><b>Additional info: </b><?php echo $product['Additional']; } ?></p>
